...
# creating take_commands() function which can take some audio, will recognize and return if there are not any errors...
def take_commands():
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "how are you" in command:
            Speak("I am good Sir and I hope you and your beloved ones are also safe and healthy.")
        if "exit" in command: 
        ...
        if 'restaurants near me' in command:
            ...
            webbrowser.open("https://www.google.com/search?q=restaurants+near+me&oq=restaurants+near+me&gs_lcrp=EgZjaHJvbWUyDwgAEEUYORixAxjJAxiABDINCAEQABiSAxiABBiKBTINCAIQABiSAxiABBiKBTIHCAMQABiABDIHCAQQABiABDIHCAUQABiABDIHCAYQABiABDIHCAcQABiABDIHCAgQABiPAjIHCAkQABiPAtIBCDQwMzFqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8")
